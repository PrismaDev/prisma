...
($(a).removeClass("row_selected"),this.resizeWhole(),$("#faltacursar-classes-div").addClass("hidden")):($(".table tr.row_selected").removeClass("row_selected"),$(a).addClass("row_selected"),$("#faltacursar-classes-div").removeClass("hidden"),faltacursarClasseslistView.render([]),this.resizeFiftyfifty())},calcTbodySize:function(a,b){$(b).height(a)},resizeFiftyfifty:function(){var a=$("#main-faltacursar-div").height()-1;this.calcTbodySize(a/2,"#faltacursar-subject-table_wrapper");this.calcTbodySize(a/
2,"#faltacursar-classes-div")},resizeWhole:function(){var a=$("#main-faltacursar-div").height();this.calcTbodySize(a,"#faltacursar-subject-table_wrapper")},initJS:function(){$("#faltacursar-subject-table").dataTable({bPaginate:!1,sDom:"ft"})},fetchStrings:function(){return{codeStr:"Codigo",nameStr:"Nome da Disciplina",moreInfoStr:"Ementa",termStr:"Periodo",infoStr:"Ementa"}},fetchSubjects:function(){return{subjects:[{code:"MAT1015",name:"Teste teste teste",term:"2",link:"#"},{code:"ENG1015",name:"Teste teste teste",
...
this.initJS()}}),microhorarioClasseslistView=new ClasseslistView,faltacursarClasseslistView=new ClasseslistView({sDom:"ft"});function SelectedController(){}var selectedController=new SelectedController,MainRouter=Backbone.Router.extend({routes:{"":"main",":tab":"tabs"}}),mainRouter=new MainRouter;mainRouter.on("route:main",function(){mainView.render();mainRouter.navigate(mainView.defaultTab,{trigger:!0})});
