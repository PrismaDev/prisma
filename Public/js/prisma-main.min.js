...
type:"POST",data:$("#suggestions-form").serialize(),success:function(){$("#dialogDiv").modal("hide")}});return!1}}),suggestionsView=new SuggestionsView,UpdatesView=Backbone.View.extend({templateId:"#updates-template",args:{}}),updatesView=new UpdatesView;function overriddenGet(a,b){var c=serverDictionary.get(b);return Backbone.Model.prototype.get.call(a,c)}
