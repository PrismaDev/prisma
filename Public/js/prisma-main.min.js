...
this.initHelpers()},initHelpers:function(){helpersList.get("selectedRow").set("selector","#main-selected-div tr");helpersList.get("selectedClass").set("selector","#main-selected-div td:has(div):not(.radio)");$(helpersList.get("selectedClass").get("selector")).live("mouseover",function(a){a.stopImmediatePropagation()})},changeInfo:function(a,b){var c=$("#info-container");c.find("#qtd-credits").html(a+" "+selectedStringsModel.get("qtdCreditsLabel"));c.find("#qtd-classes").html(b+" "+selectedStringsModel.get("qtdClassesLabel"))},
