...
position:{my:"top center",at:"bottom center",viewport:$(window)},style:{classes:"qtip-bootstrap qtip-blue"}})}}),helperView=new HelperView,MainView=Backbone.View.extend({el:"",template:"",rendered:!1,tabs:{faltacursar:{li:"main-faltacursar-li",div:"main-faltacursar-div",href:"#faltacursar",view:faltacursarView},microhorario:{li:"main-microhorario-li",div:"main-microhorario-div",href:"#microhorario",view:microhorarioView},selected:{li:"main-selected-li",div:"main-selected-div",href:"#selected",view:selectedView}},
defaultTab:"faltacursar",timetableDiv:"",sidebarDiv:"",tabsNav:"",initialize:function(){this.template=_.template($("#main-template").html());var a=this;$(window).resize(function(){a.equalMainDivsHeight()})},cache:function(){this.timetableDiv=document.getElementById("main-timetable-div");this.sidebarDiv=document.getElementById("main-sidebar-div");this.tabsNav=document.getElementById("main-tabs-nav")},equalMainDivsHeight:function(){var a=$(this.timetableDiv).height()-1;$(this.sidebarDiv).height(a);
a-=$(this.tabsNav).outerHeight(!0);faltacursarView.$el.height(a);microhorarioView.$el.height(a);selectedView.$el.height(a)},setActiveTab:function(a){$("#main-tabs-nav li").removeClass("active");$("#main-tab-panes div").removeClass("active");$("#"+this.tabs[a].li).addClass("active");$("#"+this.tabs[a].div).addClass("active");this.tabs[a].view.resize();"selected"==a&&selectedModel.set("addedSinceLastView",0)},changeBadge:function(a){a?($("#selected-badge").html(a),$("#selected-badge").removeClass("hidden")):
$("#selected-badge").addClass("hidden")},renderSubviews:function(){timetableView.setElement("#main-timetable-div");timetableView.render();faltacursarView.setElement("#main-faltacursar-div");faltacursarView.render();microhorarioView.setElement("#main-microhorario-div");microhorarioView.render();selectedView.setElement("#main-selected-div");selectedView.render()},render:function(){this.$el.html(this.template({tabs:this.tabs,mainStr:mainStringsModel}));this.renderSubviews();this.rendered=!0;this.cache()}}),
mainView=new MainView,ClasseslistView=Backbone.View.extend({templateTable:"",templateRow:"",el:"",subjectInfo:"",classesDatatable:null,classesTableHead:"",classesTableBody:"",events:{"click .dataTables_scrollBody tr":"clickOnClass"},clickOnClass:function(a){a=$(a.target).parents("tr");if(!$(a).hasClass("subjectDisabled")&&!$(a.find("td").first()).hasClass("dataTables_empty")){var b=$(a).find('input[type="hidden"][name="subjectCode"]').attr("value"),c=$(a).find('input[type="hidden"][name="classId"]').attr("value");
