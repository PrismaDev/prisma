...
this.initJS()}}),microhorarioClasseslistView=new ClasseslistView,faltacursarClasseslistView=new ClasseslistView;function SelectedController(){}var selectedController=new SelectedController,MainRouter=Backbone.Router.extend({routes:{"":"main",":tab":"tabs"}}),mainRouter=new MainRouter;mainRouter.on("route:main",function(){mainView.render();mainRouter.navigate(mainView.defaultTab,{trigger:!0})});
