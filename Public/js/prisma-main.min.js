...
$(this.dialogDiv).modal("show")},openUpdatesDialog:function(){updatesView.render();$(this.dialogDiv).modal("show")},preventClose:function(a){a.stopPropagation()},initialize:function(){this.template=_.template($("#layout-template").html())},initJS:function(){$(".dropdown-toggle").dropdown();fbApiController.loadApi()},setView:function(a){this.contentView=a},prepareDialogs:function(){this.loggedIn&&(suggestionsView.setElement(this.dialogDiv),updatesView.setElement(this.dialogDiv));faqView.setElement(this.dialogDiv);
tutorialView.setElement(this.dialogDiv)},render:function(){var a={layoutStr:layoutStringsModel,loggedIn:this.loggedIn};this.loggedIn||(a={layoutStr:layoutStringsModel,loggedIn:this.loggedIn,loginStr:loginStringsModel});this.$el.html(this.template(a));this.prepareDialogs();this.initJS();this.contentView&&this.contentView.setElement("#content-div")}});
