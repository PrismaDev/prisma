...
faltacursarClasseslistView.resizeH())},calculateTableScroll:function(){var a=$(this.subjectTableWrapper).height(),b=$(this.subjectTableFilter).outerHeight(!0)+$(this.subjectTableHeader).outerHeight(!0),c=$(this.subjectTableBody).outerHeight(!0)-$(this.subjectTableBody).height();$(this.subjectTableBody).height(a-b-c)},resizeW:function(){this.subjectDatatable.fnAdjustColumnSizing(!1);this.calculateTableScroll();faltacursarClasseslistView.resizeW()},resizeH:function(){this.calculateTableScroll()},initJS:function(){this.subjectDatatable=
$("#faltacursar-subject-table").dataTable({sDom:"ft",bPaginate:!1,bScrollCollapse:!0,sScrollY:"200px"});$("#faltacursar-subject-table_wrapper").addClass("whole")},fetchStrings:function(){return{codeStr:"Codigo",nameStr:"Nome da Disciplina",moreInfoStr:"Ementa",termStr:"Periodo",infoStr:"Ementa"}},fetchSubjects:function(){return{subjects:[{code:"MAT1015",name:"Teste teste teste",term:"2",link:"#"},{code:"ENG1015",name:"Teste teste teste",term:"2",link:"#"},{code:"ENG1015",name:"Teste teste teste",
term:"2",link:"#"},{code:"ENG1015",name:"Teste teste teste",term:"2",link:"#"},{code:"ENG1015",name:"Teste teste teste",term:"2",link:"#"},{code:"ENG1015",name:"Teste teste teste",term:"2",link:"#"},{code:"ENG1015",name:"Teste teste teste",term:"2",link:"#"},{code:"ENG1015",name:"Teste teste teste",term:"2",link:"#"},{code:"ENG1015",name:"Teste teste teste",term:"2",link:"#"},{code:"MAT1015",name:"Teste teste teste",term:"2",link:"#"},{code:"MAT1015",name:"Teste teste teste",term:"2",link:"#"},{code:"MAT1015",
name:"Teste teste teste",term:"2",link:"#"},{code:"MAT1015",name:"Teste teste teste",term:"2",link:"#"},{code:"MAT1015",name:"Teste teste teste",term:"2",link:"#"},{code:"MAT1015",name:"Teste teste teste",term:"2",link:"#"},{code:"MAT1015",name:"Teste teste teste",term:"2",link:"#"},{code:"MAT1015",name:"Teste teste teste",term:"2",link:"#"},{code:"MAT1015",name:"Teste teste teste",term:"2",link:"#"},{code:"MAT1015",name:"Teste teste teste",term:"2",link:"#"}]}},fetchData:function(){return $.extend({},
this.fetchStrings(),this.fetchSubjects())},render:function(){this.$el.html(this.template(this.fetchData()));this.initJS();this.cache();faltacursarClasseslistView.setElement("#faltacursar-classes-div");faltacursarClasseslistView.render([])}}),faltacursarView=new FaltacursarView,MicrohorarioView=Backbone.View.extend({template:"",waitingTemplate:"",noQueryTemplate:"",resultsDiv:"",noQueryStatus:"noQuery",queryStatus:"query",waitingStatus:"waiting",waitingImgURL:"http://i.stack.imgur.com/FhHRx.gif",resizeW:function(){},
...
openFilters:function(){$("#microhorario-filter").removeClass("hidden");$("#openFiltersButton").addClass("hidden");$("#closeFiltersButton").removeClass("hidden")},closeFilters:function(){$("#microhorario-filter").addClass("hidden");$("#openFiltersButton").removeClass("hidden");$("#closeFiltersButton").addClass("hidden")},initialize:function(){this.template=_.template($("#microhorario-template").html());this.waitingTemplate=_.template($("#microhorario-waiting-template").html());this.noQueryTemplate=
_.template($("#microhorario-noquery-template").html())},changeState:function(a,b){void 0==typeof b&&(b=[]);a==this.queryStatus?(microhorarioClasseslistView.render(b),this.closeFilters()):a==this.noQueryStatus?this.$resultsDiv.html(this.noQueryTemplate({noQueryStr:"No query"})):this.$resultsDiv.html(this.waitingTemplate({waitingImgURL:this.waitingImgURL}))},fetchStrings:function(){return{noQueryStr:"No query",subjectCodeStr:"Codigo da Disciplina:",subjectNameStr:"Nome da Disciplina:",professorNameStr:"Nome do Professor:",
toggleBlocked:"Exibir disciplinas bloqueadas",moreFiltersStr:"More filters",lessFiltersStr:"Less filters",openFiltersStr:"Open filters",closeFiltersStr:"Close filters"}},render:function(){this.$el.html(this.template(this.fetchStrings()));this.$resultsDiv=$("#microhorario-results");microhorarioClasseslistView.setElement(this.$resultsDiv);this.changeState(this.queryStatus)}}),microhorarioView=new MicrohorarioView,DatatableView=Backbone.View.extend({el:"",sDom:"t",table:"",resizeW:function(){table.fnDraw()},
resizeH:function(){this.$el.height()},initialize:function(){void 0!=this.options.sDom&&(this.sDom=this.options.sDom);el=this.options.el;this.table=this.$el.dataTable({sDom:this.options.sDom})}}),SelectedView=Backbone.View.extend({events:{"click #main-selected-div li":"handleClick"},handleClick:function(a){if($(a.target).hasClass("btn-primary"))$(a.target).removeClass("btn-primary");else{var b=a.target.parent();$($(b).find("li")).each(function(a,b){$(b).removeClass("btn-primary")});$(a.target).addClass("btn-primary")}},
...
b=$(this.sidebarDiv).outerWidth(!0),c=$(this.sidebarDiv).width(),d=$(this.timetableDiv).outerWidth(!0),e=$(this.timetableDiv).width(),f=a-b;$(this.timetableDiv).width(f-(d-e)-1);$(this.sidebarDiv).width(c);$(this.timetableDiv).width()<$(this.timetableTable).width()&&(f=a-d,$(this.timetableDiv).width(e),$(this.sidebarDiv).width(f-(b-c)-1))},initJS:function(){var a=0;$(this.tabsNav).find("li").each(function(){a+=$(this).outerWidth(!0)});a+=1;$(this.sidebarDiv).resizable({handles:"e, w",minWidth:a,containment:"parent",
resize:this.setTimetableWFromSidebarW})},setActiveTab:function(a){$("#main-tabs-nav li").removeClass("active");$("#main-tab-panes div").removeClass("active");$("#"+this.tabs[a].li).addClass("active");$("#"+this.tabs[a].div).addClass("active");this.tabs[a].view.resizeW();this.tabs[a].view.resizeH()},fetchStrings:function(){this.tabs.faltacursar.str="Falta Cursar";this.tabs.microhorario.str="Micro Horario";this.tabs.selected.str="Selecionadas"},renderSubviews:function(){timetableView.setElement("#main-timetable-div");
